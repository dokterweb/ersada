                        ...
                        <div class="col-md-4">
                            <table class="table table-sm table-border">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Rp {{ number_format($pembiayaan->plafond,0,',','.') }}
                                    </td>
                                </tr>
                            ...
                            @foreach($pembiayaan->angsurans as $angsuran)
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        {{ number_format($angsuran->pokok_angsuran,0,',','.') }}
                
                                    </td>
                
                                    <td class="text-end">
                
                                        {{ number_format($angsuran->bunga_angsuran,0,',','.') }}
                                    ...
                                    <td class="text-end">
                                        ...
                                        {{ number_format($angsuran->total_angsuran,0,',','.') }}
                                    ...
                                    <td class="text-end">
                                        ...
                                        {{ number_format($angsuran->sisa_pokok,0,',','.') }}
