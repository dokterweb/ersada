        ...
        <div class="row row-cards">
          <div class="col-lg-12">
            ...
            <form action="{{ route('pengajuan.storeJaminan',$pengajuan->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <button type="button" id="addJaminan" class="btn btn-success mb-4">
                    + Tambah Jaminan
                </button>
                    ...
                    @foreach($jaminans as $index => $jaminan)
                        ...
                        >
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        >
                                            ...
                                            <option value="BPKB Motor" {{ $jaminan->jenis_jaminan == 'BPKB Motor' ? 'selected' : '' }}>
                                                BPKB Motor
                                            </option>
                                            <option value="BPKB Mobil" {{ $jaminan->jenis_jaminan == 'BPKB Mobil' ? 'selected' : '' }}>
                                                BPKB Mobil
                                            </option>
                                            <option value="Surat Tanah" {{ $jaminan->jenis_jaminan == 'Surat Tanah' ? 'selected' : '' }}>
                                                Surat Tanah
                                            </option>
                                            <option value="Payroll" {{ $jaminan->jenis_jaminan == 'Payroll' ? 'selected' : '' }}>
                                                    Payroll
                                            </option>
                                        </select>
                                ...
                                <div
                                    class="data-payroll"
                                    style="{{ $jaminan->jenis_jaminan == 'Payroll' ? '' : 'display:none;' }}"
                                >

                                    <div class="alert alert-success">
                                        <strong>DATA JAMINAN PAYROLL</strong>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <input
                                                type="file"
                                                name="jaminan[{{ $index }}][dokumen][bpjs_ketenagakerjaan][]"
                                                class="form-control"
                                                multiple
                                                accept=".jpg,.jpeg,.png,.pdf"
                                            >
                                            ...
                                            @foreach(
                                                $jaminan->dokumenJaminans
                                                    ->where('jenis_dokumen','bpjs_ketenagakerjaan')
                                                as $dokumen
                                            )
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <input
                                                type="file"
                                                name="jaminan[{{ $index }}][dokumen][buku_tabungan][]"
                                                class="form-control"
                                                multiple
                                                accept=".jpg,.jpeg,.png,.pdf"
                                            >
                                            ...
                                            @foreach(
                                                $jaminan->dokumenJaminans
                                                    ->where('jenis_dokumen','buku_tabungan')
                                                as $dokumen
                                            )
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <input
                                                type="file"
                                                name="jaminan[{{ $index }}][dokumen][atm][]"
                                                class="form-control"
                                                multiple
                                                accept=".jpg,.jpeg,.png,.pdf"
                                            >
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <input
                                                type="file"
                                                name="jaminan[{{ $index }}][dokumen][slip_gaji][]"
                                                class="form-control"
                                                multiple
                                                accept=".jpg,.jpeg,.png,.pdf"
                                            >
...
$(document).ready(function () {
    ...
    */
    ...
    function toggleJaminan(container)
    {
        ...
        let payroll = container.find('.data-payroll');
        ...
        else if (jenis === 'Payroll') {

            kendaraan.hide();
            tanah.hide();
            payroll.slideDown(200);
