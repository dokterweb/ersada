    ...
    <div class="page-body">
      <div class="container-xl">
        <div class="row row-cards">
          <div class="col-lg-12">
            <form action="{{ route('absensiustadzs.index') }}" method="GET" class="card">
              @csrf
            ...
            <div class="card">
              ...
              <div class="table-responsive p-3">
                <table id="mytable" class="table table-vcenter card-table">
                  ...
                  <tbody>
                    @foreach($absensiUstadz as $absensi)
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-warning btn-sm  btn-edit" data-bs-toggle="modal" data-bs-target="#editModal"
                                    ...
                                    data-siswa-nama="{{ $absensi->ustadz->user->name }}">Edit
                                </button>
                            </td>
                        </tr>
                    @endforeach
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editModalLabel">Edit Absensi ustadz</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="editAbsensiForm" method="POST" action="{{ route('absensiustadzs.update', ':id') }}">
          @csrf
          @method('PUT')
          
          <!-- Nama ustadz (readonly) -->
          <div class="mb-3">
              <label class="form-label">Nama ustadz</label>
              <input type="text" class="form-control" id="modal-nama-ustadz" readonly>
          </div>
...
<script>
  ...
  $(document).on('click', '.btn-edit', function () {
      ...
      $.ajax({
          url: `/absensi-ustadz/${absensiId}/edit`, // Pastikan URL edit benar
          type: 'GET',
          success: function (data) {
              ...
              $('#modal-nama-ustadz').val(data.ustadz.user.name); // Nama ustadz
              ...
              $('#editAbsensiForm').attr('action', `/absensi-ustadz/${data.id}`);
