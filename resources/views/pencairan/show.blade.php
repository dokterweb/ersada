                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <th>Metode</th>
                                    <td>{{ ucfirst($pencairan->metode) }}</td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-md-6">
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    <th width="25%">Nama</th>
                                    <td>{{ $pencairan->akad->pembiayaan->pengajuan->nasabah->nama }}</td>
                                </tr>
                                <tr>
                                    <th>NIK</th>
                                    <td>{{ $pencairan->akad->pembiayaan->pengajuan->nasabah->nik }}</td>
                                </tr>
                                <tr>
                                    <th>Marketing</th>
                                    <td>{{ $pencairan->akad->pembiayaan->pengajuan->marketing->user->name }}</td>
                                </tr>
                                <tr>
                                    <th>Cabang</th>
                                    <td>{{ $pencairan->akad->pembiayaan->pengajuan->cabang->nama_cabang }}</td>
                                </tr>
                            </table>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td>Rp {{ number_format($pencairan->akad->pembiayaan->plafond,0,',','.') }}</td>
                                </tr>
                                <tr>
                                    <th>Administrasi</th>
                                    <td>Rp {{ number_format($pencairan->akad->pembiayaan->biaya_administrasi,0,',','.') }}</td>
                                </tr>
                                <tr>
                                    <th>Materai</th>
                                    <td>Rp {{ number_format($pencairan->akad->pembiayaan->materai,0,',','.') }}</td>
                                </tr>
                                <tr>
                                    <th>Biaya Survey</th>
