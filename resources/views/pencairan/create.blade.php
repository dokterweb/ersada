                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input
                                type="text"
                                class="form-control"
                                value="{{ $akad->pembiayaan->pengajuan->nasabah->nama }}"
                                readonly>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input
                                type="text"
                                class="form-control"
                                value="{{ $akad->pembiayaan->pengajuan->marketing->user->name ?? '-' }}"
                                readonly>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input
                                type="text"
                                class="form-control"
                                value="{{ $akad->pembiayaan->pengajuan->cabang->nama_cabang ?? '-' }}"
                                readonly>
                        </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    Rp {{ number_format($akad->pembiayaan->plafond,0,',','.') }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th>Administrasi</th>
                                <td>
                                    Rp {{ number_format($akad->pembiayaan->biaya_administrasi,0,',','.') }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th>Materai</th>
                                <td>
                                    Rp {{ number_format($akad->pembiayaan->materai,0,',','.') }}
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th>Biaya Survey</th>
                                <td>
                                    Rp {{ number_format($akad->pembiayaan->biaya_survey,0,',','.') }}
                                </td>
                            </tr>
                            ...
                            <tr class="table-success">
                                ...
                                <th>
                                    Rp {{ number_format($akad->pembiayaan->dana_diterima,0,',','.') }}
                                </th>
